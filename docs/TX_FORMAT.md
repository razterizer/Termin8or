...
* `VER 2.1`: `-` material sentinel support (`-` represents `raw_mat_none` decoded into `mat_none`, typically for AdHoc textels in [`TextUR`](https://github.com/razterizer/TextUR)).
